<%@ page language="java" contentType="text/html; charset=utf-8"
	pageEncoding="utf-8" import="libsys.MemberDao"%>
...
<body>
	<div class="register">
		<div class="form-box">
			...
			<form class="register-form" action="registerdone" method="post" name="userInfo" onsubmit="return checkValue()">
